...
export default function Home() {
  ...
  return (
    <div className="space-y-6">
      {/* Hero Section */}
      <section className="bg-linear-to-r from-indigo-600 via-indigo-500 to-indigo-700 text-white rounded-2xl shadow-lg overflow-hidden">
        <div className="px-6 py-6 sm:px-10 sm:py-8 flex flex-col md:flex-row items-center gap-6 md:gap-10">
          <div className="flex-1">
            <p className="inline-flex items-center text-[11px] font-semibold uppercase tracking-wider bg-white/10 px-3 py-1 rounded-full mb-3">
              New season • Best deals
            </p>
            <h1 className="text-3xl sm:text-4xl font-extrabold mb-2 leading-tight">
              Welcome to{" "}
              <span className="text-yellow-300 drop-shadow-sm">ShopSmart</span>
            </h1>
            <p className="text-sm sm:text-base text-indigo-100 mb-4 max-w-xl">
              Discover hand-picked products at great prices. Browse, explore,
              and add your favourites to the cart. Click on any product to view
              full details like a real ecommerce app.
            </p>

            <div className="flex flex-wrap items-center gap-3 mt-2">
              <Link
                to="/products"
                className="inline-flex items-center justify-center text-sm font-semibold bg-white text-indigo-700 px-4 py-2.5 rounded-full shadow-md hover:bg-indigo-50 active:scale-[0.98] transition"
              >
                View All Products
              </Link>
              <span className="text-[12px] text-indigo-100">
                {products.length > 0
      ...
      {/* Products Grid */}
      <section className="bg-linear-to-b from-gray-50 to-gray-100 rounded-2xl shadow-sm p-4 sm:p-6">
        <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-2 mb-4">
          <div>
            ...
            <p className="text-xs text-gray-500">
              Fresh items fetched from backend (MongoDB)
            </p>
          </div>
