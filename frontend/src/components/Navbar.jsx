...
export default function Navbar() {
  ...
  // toggle handler that prevents the document-level listener from closing the menu immediately
  const toggleMobile = (e) => {
    // stop the click from bubbling to document handlers
    e?.stopPropagation();
    // prevent default (safe)
    e?.preventDefault();
    setMobileOpen((s) => !s);
  };
  ...
  useEffect(() => {
    const handleOutside = (e) => {
      ...
      if (
        ...
        // click inside menu or button -> do nothing
        return;
      }
      setMobileOpen(false);
    };
    ...
    // use capturing mousedown listener for more reliable behavior across browsers
